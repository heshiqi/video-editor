...
public interface IMediaPlayer {
     ...
     *
     * @throws if the internal player engine has not been
     *            initialized.
     */
    ...
    public interface OnTimedTextListener {
         ...
         *             {@hide}
         */
        void onTimedText(IMediaPlayer mp, HTimedText text);
    }
     ...
     *
     * @see com.h.arrow.medialib.mediaplayer.IMediaPlayer.OnInfoListener
     */
