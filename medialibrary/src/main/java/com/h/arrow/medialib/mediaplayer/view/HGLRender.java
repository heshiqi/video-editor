...
public class HGLRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    private HOnGlSurfaceViewOncreateListener onGLSurfaceViewCreateListener;
    private HOnRenderRefreshListener onRenderRefreshListener;

    public HGLRender(Context context) {
    ...
    public void setOnGLSurfaceViewCreateListener(HOnGlSurfaceViewOncreateListener onGLSurfaceViewCreateListener) {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        Log.d("hh", "onSurfaceChanged, width:" + width + ",height :" + height);
        sWidth = width;
        sHeight = height;
